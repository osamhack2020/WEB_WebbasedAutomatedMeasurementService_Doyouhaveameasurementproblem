...
> ## 다른 프로젝트와의 차별성
   - ### 독창성
      * **국방부 주관 4차 산업혁명 사업**과 관련하여 현재 사업 추진중인 **85창의 스마트시험소 사업 추진에 개념연구에 기여 가능성** 도모(현재 공정자동화 BPR/ISP 관련 내용 작성 중이나, 실 적용시 무선 보안 관련 미고려)
      * [국가표준기본법](https://www.law.go.kr/%EB%B2%95%EB%A0%B9/%EA%B5%AD%EA%B0%80%ED%91%9C%EC%A4%80%EA%B8%B0%EB%B3%B8%EB%B2%95) 및 국방부 [3군 공통군수지원 훈령](https://www.mnd.go.kr/mndSearch/front/Search.jsp)을 참고하여 3군의 무기체계 소급성 유지를 위한 근거자료 제시 가능
      * **국방개혁 2.0 및 군의 4차 산업혁명**을 위해 대표적인 예시가 될 가능성이 높음
      * 반응형 웹 및 현 군에서 운용되고 있는 카카오톡 채널 등 다양하게 연동되는 활용 가능성 기대
   - ### 발전 가능성
      * 미래학자가 언급한 **코로나로 삶의 정착이 될 비대면 서비스 주제**에 적합
      * **군의 신규 무기체계 사업은 지속되기 때문에 향후 지속 발전 가능성**에 대해 상당항 영향 기여 예상
      * 오픈 소스로 개발되어 해당 **플랫폼 및 서비스 구축 비용 절감**
      * **산업 계측기**는 대형 민간업체부터 중소기업까지 다양하게 활용되어 커뮤니티 발전 가능성 높음
      * 측정값이 Database에 지속 누적 시 **향후 예측 정비**에 크게 기여
      * 군 내부 운영 중인 **국방군수통합정보체계와 연동 가능성** 내제
