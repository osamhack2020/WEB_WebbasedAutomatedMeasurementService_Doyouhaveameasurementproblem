...
> ## 다른 프로젝트와의 차별성
   - ### 독창성
      * 국방부 주관 4차 산업혁명 사업과 관련하여 현재 사업 추진중인 85창의 스마트시험소 사업 추진에 가능성 도모(현재 공정자동화 BPR/ISP 관련 내용 작성 중이나, 실 적용시 무선 보안 관련 미고려)
      ...
      * 국방개혁 2.0 및 군의 4차 산업혁명을 위해 대표적인 예시가 될 가능성이 높음
      * 반응형 웹 및 현 군에서 운용되고 있는 카카오톡 채널 등 다양하게 활용 가능성 기대
   - ### 발전 가능성
      * 미래학자가 언급한 코로나로 삶의 정착이 될 비대면 서비스 주제에 적합
      * 군의 신규 무기체계 사업은 지속되기 떄문에 향후 지속 발전 가능성에 대해 상당항 영향 기여 예상
      * 오픈 소스로 개발되어 해당 플랫폼 및 서비스 구축 비용 절감
      * 산업 계측기는 대형 민간업체부터 중소기업까지 다양하게 활용되어 커뮤니티 발전 가능성 높음
      * 측정값이 Database에 지속 누적 시 향후 예측 정비에 크게 기여
